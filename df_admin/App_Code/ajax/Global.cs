...
public class Global
{
    ...
    public HI_ACCESS_LEVEL hiAccessLevel = HI_ACCESS_LEVEL.NOT_LOGGED_IN;

    public ACCESS_CONTROLLER accessController = new ACCESS_CONTROLLER();

    public bool bDEBUG_TESTING_OLD_DATABASE = false;

    public string getCurrentChain()
    {
        if (accessController == null) return "";
        return accessController.getChainID();
    }
    ...
    public string chain_level_1(Global global)
    {
        ...
        if (!global.accessController.isSuperUser())
        {
            s3 = "";
            s4 = "";
        }
    ...
    public string chain_level_2_1(Global global)
    {
        ...
        sb.Append(HTML_TOOLBOX.link_TWITTER_call_javascript_function("Butikker - Live", "level_2_live_start_show()", 12, true, "margin-left:30px;margin-right:30px;"));

        sb.Append(HTML_TOOLBOX.left_buffer(20));
        sb.Append(HTML_TOOLBOX.link_TWITTER_call_javascript_function("Status", "level_2_report_show_all_shops()", 12, true, "margin-left:30px;margin-right:30px;"));

        if (global.accessController.isSuperUser())
        {
            sb.Append(HTML_TOOLBOX.left_buffer(20));
            sb.Append(HTML_TOOLBOX.link_TWITTER_call_javascript_function("Oppdater nøkkelinformasjon", "level_2_update_show_all_shops()", 12, true, "margin-left:30px;margin-right:30px;"));
        }
        sb.Append(HTML_TOOLBOX.left_buffer(10));
    ...
    public string chain_level_2_2(Global global)
    {
        ...
        if (global.accessController.isSuperUser())
        {
            sb.Append(HTML_TOOLBOX.link_TWITTER_call_javascript_function("Standardrapport", "level_2_report_2()", 12, true, "margin-left:30px;margin-right:30px;"));
            sb.Append(HTML_TOOLBOX.left_buffer(20));
            sb.Append(HTML_TOOLBOX.link_TWITTER_call_javascript_function("Fakturagrunnlag", "level_2_shop_report_show_chain_invoice()", 12, true, "margin-left:30px;margin-right:30px;"));
            sb.Append(HTML_TOOLBOX.left_buffer(20));
            sb.Append(HTML_TOOLBOX.link_TWITTER_call_javascript_function("Dashboard OLD", "level_2_report_3()", 12, true, "margin-left:30px;margin-right:30px;"));
            sb.Append(HTML_TOOLBOX.left_buffer(20));
        }
        sb.Append(HTML_TOOLBOX.link_TWITTER_call_javascript_function("Dashboard", "level_2_report_4(" + ((int) DASHBOARD_PERIOD.THIS_MONTH).ToString() + ")", 12, true, "margin-left:30px;margin-right:30px;"));
    ...
    public string chain_level_2_4()
    {
        ...
        sb.Append(HTML_TOOLBOX.div_START_input_container_TWITTER(10, 10, 20, 20, "background-color:rgb(250,250,250);", "menu_x"));
        sb.Append(HTML_TOOLBOX.left_buffer(10));
        sb.Append(HTML_TOOLBOX.link_TWITTER_call_javascript_function("Analyse 1", "level_2_analyze_1()", 12, true, "margin-left:30px;margin-right:30px;"));
        sb.Append(HTML_TOOLBOX.left_buffer(20));
        sb.Append(HTML_TOOLBOX.link_TWITTER_call_javascript_function("Analyse 2", "level_2_analyze_2()", 12, true, "margin-left:30px;margin-right:30px;"));
        sb.Append(HTML_TOOLBOX.left_buffer(20));
        sb.Append(HTML_TOOLBOX.link_TWITTER_call_javascript_function("Analyse 3", "level_2_analyze_3()", 12, true, "margin-left:30px;margin-right:30px;"));
        sb.Append(HTML_TOOLBOX.left_buffer(20));
        sb.Append(HTML_TOOLBOX.link_TWITTER_call_javascript_function("Analyse 4", "level_2_analyze_4()", 12, true, "margin-left:30px;margin-right:30px;"));
        sb.Append(HTML_TOOLBOX.left_buffer(10));
        sb.Append(HTML_TOOLBOX.div_END());
        return sb.ToString();
    }
    ...
    public string chain_menu_2_3()
    {
        ...
        sb.Append(HTML_TOOLBOX.link_TWITTER_call_javascript_function("Responstid terminal - webservices", "level_2_report_verifone_to_webservice()", 12, true, "margin-left:30px;margin-right:30px;"));
        sb.Append(HTML_TOOLBOX.left_buffer(10));
        sb.Append(HTML_TOOLBOX.link_TWITTER_call_javascript_function("Azure deployment", "level_2_report_azure_deployment()", 12, true, "margin-left:30px;margin-right:30px;"));
        sb.Append(HTML_TOOLBOX.left_buffer(10));
        sb.Append(HTML_TOOLBOX.div_END());
